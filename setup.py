...
plugin_identifier = "displayz"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_displayz"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-DisplayZ"
...
# module
plugin_description = """Brings back the current Z display in the state sidebar panel"""
...
plugin_url = "https://github.com/foosel/OctoPrint-DisplayZ"
